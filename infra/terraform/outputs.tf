...
output "aws_s3_hellotesting123harshavardhan123_bucket_name" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.bucket_name
  sensitive = false
}


output "aws_s3_hellotesting123harshavardhan123_bucket_website_endpoint" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.bucket_website_endpoint
  sensitive = false
}


output "aws_s3_hellotesting123harshavardhan123_kms_arn" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.kms_arn
  sensitive = false
}


output "aws_s3_hellotesting123harshavardhan123_arn" {
